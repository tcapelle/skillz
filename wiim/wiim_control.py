...
match args.action:
    case "play":
        api(host, "setPlayerCmd:resume")
        console.print("[green]Playing[/green]")

    case "pause":
        api(host, "setPlayerCmd:pause")
        console.print("[yellow]Paused[/yellow]")

    case "toggle":
        api(host, "setPlayerCmd:onepause")
    ...
    case "next":
        api(host, "setPlayerCmd:next")
        console.print("[green]Next track[/green]")

    case "prev":
        api(host, "setPlayerCmd:prev")
    ...
    case "mute":
        api(host, "setPlayerCmd:mute:1")
        console.print("[yellow]Muted[/yellow]")

    case "unmute":
        api(host, "setPlayerCmd:mute:0")
